...
class FailedUnlockIncidentCreator(
    ...
    suspend fun createIncidentShell(failedAttemptCount: Int): Long? {
        ...
        val incident = SecurityIncident(
            ...
            videoEnabled = settings.videoCaptureEnabled,
            ...
            videoStatus = if (settings.videoCaptureEnabled) STATUS_NOT_ATTEMPTED else STATUS_DISABLED,
            locationStatus = if (settings.locationCaptureEnabled) STATUS_NOT_ATTEMPTED else STATUS_DISABLED,
